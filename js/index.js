$(document).ready(function () {
  ...
  socket.on("connect", function (e) {
    ...
    // socket.on("roomListener", function (data) {
    //   console.log("data roomListener : ", data)
    // })

    // socket.on("room_tersedia", function (data) {
    //   console.log("room_tersedia : ", data)
    // })
  })

  // socket.on("roomListener", function (data) {
  //   console.log("data roomListener 2 : ", data)
  // })
  ...
  function connectToMatch(match_id_param) {
    console.log("connectToMatch : ", match_id_param)
    ...
    socket.on("connect", function () {
      ...
      $("#admin-cr-status").html(`Control Room - #${match_id_param}<br>`)
  ...
  $("#applyBtn").click(function () {
    console.log("players : ", matchConfig.players)
  ...
  function drawConfig() {
    ...
    $("#admin_p1nameInput").val(matchConfig.players[0])
    $("#admin_p2nameInput").val(matchConfig.players[1])
  }
  ...
  $("#host").click(function () {
    ...
    matchConfig.players[0] = player1_name;
    matchConfig.players[1] = player2_name;
  ...
  function emitMatchConfig() {
    if (socket != undefined) {
      console.log("match_config : ", matchConfig)
      socket.emit(
